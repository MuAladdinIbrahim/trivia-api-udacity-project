...
To run the server, Don't forget to execute:
...
```
you can drop your test db using dropdb trivia_test
...
* Consider using Curl or Postman.
* Sample: ` http://127.0.0.1:5000/categories`<br> 
...
* Sample: ` http://127.0.0.1:5000/questions`<br>
...
* Sample: ` http://127.0.0.1:5000/questions/6 -X DELETE`<br>
...
* Sample: ` http://127.0.0.1:5000/questions -X POST -H "Content-Type: application/json" -d '{
...
* Sample: ` http://127.0.0.1:5000/questions -X POST -H "Content-Type: application/json" -d '{"searchTerm": "which"}'`<br>
...
* General:
  ...
  * Returns JSON object with paginated matching questions.
* Sample: ` http://127.0.0.1:5000/categories/1/questions`<br>
...
* Sample: ` http://127.0.0.1:5000/quizzes -X POST -H "Content-Type: application/json" -d '{"previous_questions": [20, 21],
...
Muhammad Aladdin authored the API (`__init__.py`) and test suite (`test_flaskr.py`)<br>
